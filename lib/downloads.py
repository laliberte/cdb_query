...
def download_raw(database,options,queues_manager=None):
    ...
    download_and_download_raw(database,options,output,queues_manager)
    return

def download(database,options,queues_manager=None):
    output=options.out_netcdf_file
    download_and_download_raw(database,options,output,queues_manager)
    return

def download_and_download_raw(database,options,output,queues_manager):
