...
.. attention:: This package has many prerequisites. Most of them are common on Linux systems. If your system has:

             * Support for netCDF files
             * A complete distribution of Python 2.7.x (eg Enthough Python)
             
             It is likely that most installations steps could be skipped. In this case, try::
             ...
             This last step is likely to require root access. Please ask your system administrator.

             If these steps were sucessful, you can jump to :ref:`ESG-certificates`.
...
=========================
The following tools are not necessary but are used in the recipes.
